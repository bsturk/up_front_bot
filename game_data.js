...
const TARGETING = {
    ...
    PLACE_TERRAIN_ENEMY_CARD_PRIORITY: {
        title: "Terrain Card:",
        criteria: [
            TERRAIN_TYPE_CRITERIA.IS_MINEFIELD, TERRAIN_TYPE_CRITERIA.IS_MARSH, TERRAIN_TYPE_CRITERIA.IS_STREAM
        ]
    },
    TARGET_WEAPON: {
        title: "Target Weapon:",
...
const ACTION_DEFINITIONS = {
    ...
    REMOVE_WIRE: {
        ...
        exclusivityGroup: "MOVE_PRIMARY",       // this requires a move card, so it should be part of the exlusivity group
        priorityInGroup: 7
    },
    ENTRENCH: {
...
const slaPriorities = {
    Line: {
        ...
        Stressed: [                                                                                     
            ...
            { actionRef: "MOVE_RETREAT",          rncCondition:   { black: ["3...6"], red: ["0...1"]},  priority:  0 },
